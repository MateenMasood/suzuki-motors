...
$(document).ready(()=>{
    ...
    // Datatable with rows
    var $dataTableRows = $("#tblDealer").DataTable({
       bLengthChange: false,
       destroy: true,
       info: false,
       ...
       columns: [
         ...
         { data: "contact" },
         { data: "type" },
         { data: "bank_branches.bank.name" },
         { data: "bank_branches.name" },
         { data: "commission" },
     ...
     $('#tblDealer tbody').on('click', 'tr', function () {
     ...
     function controlCheckAll() {
       ...
       var allChecked = true;
       $('#tblDealer tbody tr .custom-checkbox input').each(function () {
     ...
     function unCheckAllRows() {
       $('#tblDealer tbody tr').removeClass('selected');
       $('#tblDealer tbody tr .custom-checkbox input').prop("checked", false).trigger("change");
     }

     function checkAllRows() {
       $('#tblDealer tbody tr').addClass('selected');
       $('#tblDealer tbody tr .custom-checkbox input').prop("checked", true).trigger("change");
     }
