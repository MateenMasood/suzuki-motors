...
/************* Product Price Add Form Validation********** */
    jQuery("#formAddInsuranceProgram").validate({
        ...
        messages: {
            ...
            "insuranceType": {
                required: "Please select a insurance Type",
            },
            "price": {
    ...
    function addInsuranceProgram(form) {
        $.ajax({
            url: "/insurance-programs",
            type: "post",
