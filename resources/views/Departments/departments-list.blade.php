...
{{-- **********************  controller-name:  Department/DepartmentController  *** --}}
...
<main>
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                    <table id="tblDepartments" class="data-table responsive nowrap"
                        data-order="[[ 1, &quot;desc&quot; ]]">
                        <thead>
                            <tr>
                                <th>Sr# </th>
    ...
    <!-- Start of edit modal  -->
    @include("Departments.departments-edit");
    <!-- End of edit Modal -->
...
<script src="{{ asset('assets/js/vendor/notify.js') }}"></script>
   ...
   <script src="{{ asset('assets/CustomJS/Departments/departments-list.js') }}"></script>
   <script src="{{ asset('assets/CustomJS/Departments/departments-edit.js') }}"></script>
