...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('assets/CustomCss/notify-custom.css') }} " />
                    ...
                    <div class="card-body">
                        ...
                        <form id="formCreate"  enctype="multipart/form-data" name="frmProduct">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        <label for="branch"> Branch </label>
                                            <select class="form-control " data-width="100%" id="branch" name="branchId" required>
                            ...
                            <div class="row mb-3">
                               ...
                               <input data-role="tagsinput" type="text" onchange="changeVersionOptions(this)">
                             <!--End of tags input-->
