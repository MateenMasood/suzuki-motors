...
<main>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1>Products with Hold Status List</h1>

                    <div class="top-right-button-container">
                        <a href="{{ url('/product-hold/create') }}">
            ...
            <div class="row">
                <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                    <table id="tblProductHold" class="data-table responsive nowrap"
                        data-order="[[ 1, &quot;desc&quot; ]]">
                        <thead>
                            <tr>
                                <th>Sr# </th>
...
<script src="{{ asset('assets/CustomJS/Products/products-hold-list.js') }}"></script>
