        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="top-right-button-container">
                        <a href="{{ url('/corporates/create') }}">
                             <button type="button" class="btn btn-primary btn-lg top-right-button mr-1" >Add New Corporate</button>
            ...
            <div class="row">
                <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                    <table id="tblCorporates" class="data-table responsive nowrap"
                        data-order="[[ 1, &quot;desc&quot; ]]">
                        <thead>
                            <tr>
                                <th>Sr# </th>
...
<script src="{{ asset('assets/CustomJS/Corporates/corporates-list.js') }}"></script>
