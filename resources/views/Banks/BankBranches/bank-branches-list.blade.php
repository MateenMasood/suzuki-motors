...
{{-- **************** date : oct-20-2020 ************************}
{{-- **********************file-name: bank-branches-list *********************** --}}
{{-- **********************  controller-name:  Banks/BankBranches/BankBranchController  *** --}}
...
<main>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1>Bank Branches List</h1>    <div class="top-right-button-container">
                        <a href="{{ url('/bank-branches/create') }}">
            ...
            <div class="row">
                <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                    <table id="tblBankBranches" class="data-table responsive nowrap"
                        data-order="[[ 1, &quot;desc&quot; ]]">
                        <thead>
                            <tr>
                                <th>Sr# </th>
...
<script src="{{ asset('assets/CustomJS/Banks/BankBranches/bank-branches-list.js') }}"></script>
