    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <h5 class="mb-4">Create Banker</h5>
                        <form id="formCreate"  enctype="multipart/form-data" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        <label for="bankName"> Bank </label>
                                            <select class="form-control " data-width="100%" id="bankName" name="bankName" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        <label for="bankBranchId"> Bank Branch </label>
                                            <select class="form-control" data-width="100%" id="bankBranchId" name="bankBranchId" required>
                                                <option value="">Select</option>
                                               {{-- <option value="Suzuki Mehran ">Suzuki Mehran </option> --}}
                            ...
                            <div class="row">
                                {{-- *************** dealers commission amount   ********** --}}
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        <label for="commission ">Dealer commission </label>
...
@section('js')
   ...
   {{-- *********************** initilized datatables here ******* --}}
    ...
    <script src="{{ asset('assets/CustomJs/Dealers/dealer-create.js') }}"></script>
