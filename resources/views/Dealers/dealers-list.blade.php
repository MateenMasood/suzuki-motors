...
{{-- **********************  controller-name:  Banks/BankController  *** --}}
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                    <table id="tblDealer" class="data-table responsive nowrap"
                        data-order="[[ 1, &quot;desc&quot; ]]">
                        <thead>
                            <tr>
                                <th>Sr# </th>
...
<script src="{{ asset('assets/CustomJS/Dealers/dealers-list.js') }}"></script>
