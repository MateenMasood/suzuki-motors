            ...
            <div class="col-12">
                ...
                <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                    <ol class="breadcrumb pt-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Sales Executive Dashboards</li>
                    </ol>
                </nav>
                <div class="separator mb-5"></div>
            </div>
                ...
                <div class="card mb-3 progress-banner">
                    <div class="card-body justify-content-between d-flex flex-row align-items-center">
                        <div>
                            ...
                            <div>
                                <p class="lead text-white">{{ $totalSales }}</p>
                                <p class="text-small text-white">{{ Config::get('constants.total_sales') }}</p>
                            </div>
                        </div>
                ...
                <div class="card mb-3 progress-banner">
                    <div class="card-body justify-content-between d-flex flex-row align-items-center">
                        <div>
                            <i class="iconsminds-clock mr-2 text-white align-text-bottom d-inline-block"></i>
                            <div>
                                <p class="lead text-white">{{ $productOnHold }} </p>
                            <p class="text-small text-white">{{ Config::get('constants.hold_products') }}</p>
                            </div>
                        </div>
                ...
                <div class="card mb-3 progress-banner">
                    <div class="card-body justify-content-between d-flex flex-row align-items-center">
                        <div>
                            <i class="iconsminds-clock mr-2 text-white align-text-bottom d-inline-block"></i>
                            <div>
                                <p class="lead text-white">{{$pendingEnquiries}} </p>
                                <p class="text-small text-white">{{ Config::get('constants.pending_enquiries') }}</p>
                            </div>
                        </div>
                        <div>
                            <div role="progressbar"
                                class="progress-bar-circle progress-bar-banner position-relative" data-color="white"
                                data-trail-color="rgba(255,255,255,0.2)" aria-valuenow="{{ $pendingEnquiries }}" aria-valuemax="{{ $totalEnquiries }}"
                                data-show-percent="false">
                            </div>
                        </div>
                    </div>
