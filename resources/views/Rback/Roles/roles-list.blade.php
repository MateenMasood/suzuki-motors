        ...
        <div class="container-fluid">
                ...
                <div class="col-12">
                    ...
                    <div class="top-right-button-container">
                        <a href="{{ url('/roles/create') }}">
                             <button type="button" class="btn btn-primary btn-lg top-right-button mr-1" >Create Role</button>
            ...
            <div class="row">
                <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                    <table id="tblRoles" class="data-table responsive nowrap"
                        data-order="[[ 1, &quot;desc&quot; ]]">
                        <thead>
                            <tr>
                                <th>Sr# </th>
...
<script src="{{ asset('assets/CustomJS/Rback/Roles/roles-list.js') }}"></script>
