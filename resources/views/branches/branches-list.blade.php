    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <div class="top-right-button-container">
                    <a type="button" href="{{url('/branches/create')}}" class="btn btn-primary btn-lg top-right-button mr-1">ADD NEW</a>
        ...
        <div class="row">
            <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                <table id="tblBranches" class="data-table responsive nowrap"
                    data-order="[[ 1, &quot;desc&quot; ]]">
                    <thead>
                        <tr>
                            <th>Name</th>
                            ...
                            <th>Contact</th>
                            <th>Dealer Code</th>
                            <th>Key Person 1 Contact</th>
                            <th>Key Person 2 Contact</th>
                            <th>Address</th>
                            <th>Action</th>
...
@section('js')
<script src="{{asset('assets/CustomJs/Branches/branches-list.js')}}"></script>
@endsection
