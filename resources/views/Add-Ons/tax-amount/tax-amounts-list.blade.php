...
<main>
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <h1>Tax Amount List</h1>

                <div class="top-right-button-container">
                    <a type="button" href="{{url('tax-amounts/create')}}" class="btn btn-primary btn-lg top-right-button mr-1">ADD NEW</a>
        ...
        <div class="row">
            <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                <table id="tblTaxAmount" class="data-table responsive nowrap"
                    data-order="[[ 1, &quot;desc&quot; ]]">
                    <thead>
                        <tr>
                            <th>Branch</th>
...
@section('js')
<script src="{{asset('assets/CustomJs/Add-Ons/tax-amount/tax-amounts-list.js')}}"></script>
@endsection
