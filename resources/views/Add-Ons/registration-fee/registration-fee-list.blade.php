        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="top-right-button-container">
                    <a type="button" href="{{url('/registration-fee/create')}}" class="btn btn-primary btn-lg top-right-button mr-1">ADD NEW</a>
...
@section('js')
<script src="{{asset('assets/CustomJs/Add-Ons/registration-fee/registration-fee-list.js')}}"></script>
@endsection
