        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <h5 class="mb-4"></h5>
                        <form id="formAddRegistrationFee">
                            <div class="row">
                                <div class="col-md-6">
...
{{--
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="feeAmount" name="feeAmount"  placeholder="Fee Amount">
                                    </div>
                                </div>
...
<script src="{{asset('assets/CustomJs/Add-Ons/registration-fee/registration-fee-create.js')}}"></script>
@endsection
