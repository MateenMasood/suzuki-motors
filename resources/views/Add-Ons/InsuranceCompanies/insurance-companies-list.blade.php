...
{{-- **********************  controller-name:  AddOns/Insurance/InsuranceController  *** --}}
...
<main>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1>Insurance Comapny List</h1>

                    <div class="top-right-button-container">
                        <a href="{{ url('/insurance-comapny/create') }}">
                             <button type="button" class="btn btn-primary btn-lg top-right-button mr-1" >Add New Insurance Company</button>
            ...
            <div class="row">
                <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                    <table id="tblInsuranceCompanies" class="data-table responsive nowrap"
                        data-order="[[ 1, &quot;desc&quot; ]]">
                        <thead>
                           <tr>
                                <th>Sr# </th>
...
<script src="{{ asset('assets/CustomJS/Add-Ons/InsuranceCompany/insurance-companies-list.js') }}"></script>
