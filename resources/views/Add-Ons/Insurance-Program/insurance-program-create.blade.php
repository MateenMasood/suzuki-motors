    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <h1>Create Insurance Program</h1>
                <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                    <ol class="breadcrumb pt-0">
                        <li class="breadcrumb-item">
                            <a href="#">Home</a>
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <h5 class="mb-4"></h5>
                        <form id="formAddInsuranceProgram">
                            <div class="row">
                                <div class="col-md-6">
...
{{--
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="insuranceType" name="insuranceType" data-width="100%">
                                            <option value="">Select</option>
                                            <option value="1st year premium amount">1st year premium amount</option>
                                        </select>
                                    </div>
                                </div>
...
<script src="{{asset('assets/CustomJs/Add-Ons/Insurance-Program/insurance-program-create.js')}}"></script>
@endsection
