...
<main>
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <h1>Insurance Programe</h1>

                <div class="top-right-button-container">
                    <a type="button" href="{{url('insurance-programs/create')}}" class="btn btn-primary btn-lg top-right-button mr-1">ADD NEW</a>
        ...
        <div class="row">
            <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                <table id="tblInsuranceProgram" class="data-table responsive nowrap"
                    data-order="[[ 1, &quot;desc&quot; ]]">
                    <thead>
                        <tr>
                            <th>Branch</th>
...
@section('js')
<script src="{{asset('assets/CustomJs/Add-Ons/Insurance-Program/insurance-program-list.js')}}"></script>
@endsection
