    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <div class="top-right-button-container">
                    <a type="button" href="{{url('extended-warranties/create')}}" class="btn btn-primary btn-lg top-right-button mr-1">ADD NEW</a>
        ...
        <div class="row">
            <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                <table id="tblExtendedWarranties" class="data-table responsive nowrap"
                    data-order="[[ 1, &quot;desc&quot; ]]">
                    <thead>
                        <tr>
                            <th>Branch</th>
...
@section('js')
<script src="{{asset('assets/CustomJs/Add-Ons/Extended-Warranty/extended-warranty-list.js')}}"></script>
@endsection
