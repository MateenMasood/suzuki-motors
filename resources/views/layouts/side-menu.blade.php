   ...
   <div class="menu">
                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        <a href="{{url('/departments')}}" >
                            <i class="simple-icon-organization"></i> Departments
                        </a>
                    </li>
                    <li>
                        <a href="{{url('/branches')}}" >
                            <i class="iconsminds-building"></i> Branches
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('/products') }}">
                            <i class="simple-icon-social-dropbox"></i> Products
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('/corporates') }}">
                            <i class="iconsminds-business-mens"></i> Corporates
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('/enquiries') }}">
                            <i class="simple-icon-question"></i> Enquiry
                        </a>
                    </li>

                    <li>
                        <a href="{{ url('/banks') }}">
                            <i class="iconsminds-the-white-house"></i> Banks
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('/bank-branches') }}">
                            <i class="iconsminds-bank"></i> Bank Branches
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('/dealers') }}">
                            <i class="iconsminds-financial"></i> Bankers
                        </a>
                    </li>

                    <li>
                        <a href="{{ url('/product-hold') }}">
                            <i class="iconsminds-add-cart"></i> Hold product
                        </a>
                    </li>
                    <li>
                        <a href="{{url('products-prices')}}" >
                            <i class="iconsminds-pricing"></i> Products Prices
                        </a>
                    </li>
                    <li>
                        <a href="{{url('/inventories')}}" >
                            <i class="iconsminds-shop"></i> Inventory
                        </a>
                    </li>
                    <li>
                        <a href="{{url('/orders')}}" >
                            <i class="iconsminds-checkout-basket"></i> Orders
                        </a>
                    </li>
                     <li>
                        <a href="{{url('/roles')}}">
                            <i class="simple-icon-key"></i> Roles
                        </a>
                    </li>

                    <li>
                        <a href="{{url('/permissions')}}">
                            <i class="simple-icon-lock-open"></i> Permissions
                        </a>
                    </li>
                    <li>
                        <a href="{{url('/users')}}">
                    ...
                    <li>
                        <a href="#add-ons" >
                            <i class="iconsminds-library"></i> Add-Ons
                        </a>
                    </li>
        ...
        <div class="sub-menu">
            <div class="scroll">
                <ul class="list-unstyled" data-link="add-ons">
                    <li class="active">
                    <a href="{{url('extended-warranties')}}">
                            <i class="simple-icon-rocket"></i> <span class="d-inline-block">Extended Warranty</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{url('insurance-programs')}}">
                            <i class="simple-icon-pie-chart"></i> <span class="d-inline-block">Insurance Programs</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{url('tax-amounts')}}">
                            <i class="simple-icon-pie-chart"></i> <span class="d-inline-block">Tax Amounts</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{url('registration-fee')}}">
                            <i class="simple-icon-pie-chart"></i> <span class="d-inline-block">Registration Fee</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{url('insurance-comapny')}}">
                            <i class="simple-icon-pie-chart"></i> <span class="d-inline-block">Insurance Company</span>
                        </a>
                    </li>
                </ul>
